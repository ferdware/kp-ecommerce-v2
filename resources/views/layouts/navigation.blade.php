<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Shopping Cart and Login/Register Links -->
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @endphp
                <a href="{{ route('cart.index') }}" class="relative p-1 mr-4 text-gray-700 hover:text-gray-900">
                ...
                @else
                    <a href="{{ route('login') }}" class="p-1 text-gray-700 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 border-t border-gray-200">
            ...
            <div class="flex items-center px-4">
                <a href="{{ route('cart.index') }}" class="flex items-center text-gray-700">
