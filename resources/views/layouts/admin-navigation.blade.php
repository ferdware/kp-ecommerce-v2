<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <!-- Add more navigation links for your admin features -->
                    ...
                    <x-nav-link href="#" :active="request()->routeIs('admin.customers')">
                        {{ __('Customers') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Add responsive versions of your admin navigation links -->
            <x-responsive-nav-link href="#" :active="request()->routeIs('admin.products')">
                {{ __('Products') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link href="#" :active="request()->routeIs('admin.customers')">
                {{ __('Customers') }}
            </x-responsive-nav-link>
        </div>
